...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "r_b5" -parent ${Page_0}
  ipgui::add_param $IPINST -name "r_b6" -parent ${Page_0}
  ipgui::add_param $IPINST -name "r_b7" -parent ${Page_0}
  ipgui::add_param $IPINST -name "r_b8" -parent ${Page_0}
  ipgui::add_param $IPINST -name "r_b9" -parent ${Page_0}
...
proc update_PARAM_VALUE.r_b5 { PARAM_VALUE.r_b5 } {
	# Procedure called to update r_b5 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.r_b5 { PARAM_VALUE.r_b5 } {
	# Procedure called to validate r_b5
	return true
}

proc update_PARAM_VALUE.r_b6 { PARAM_VALUE.r_b6 } {
	# Procedure called to update r_b6 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.r_b6 { PARAM_VALUE.r_b6 } {
	# Procedure called to validate r_b6
	return true
}

proc update_PARAM_VALUE.r_b7 { PARAM_VALUE.r_b7 } {
	# Procedure called to update r_b7 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.r_b7 { PARAM_VALUE.r_b7 } {
	# Procedure called to validate r_b7
	return true
}

proc update_PARAM_VALUE.r_b8 { PARAM_VALUE.r_b8 } {
	# Procedure called to update r_b8 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.r_b8 { PARAM_VALUE.r_b8 } {
	# Procedure called to validate r_b8
	return true
}

proc update_PARAM_VALUE.r_b9 { PARAM_VALUE.r_b9 } {
	# Procedure called to update r_b9 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.r_b9 { PARAM_VALUE.r_b9 } {
	# Procedure called to validate r_b9
	return true
}
...
proc update_MODELPARAM_VALUE.r_b5 { MODELPARAM_VALUE.r_b5 PARAM_VALUE.r_b5 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.r_b5}] ${MODELPARAM_VALUE.r_b5}
}

proc update_MODELPARAM_VALUE.r_b6 { MODELPARAM_VALUE.r_b6 PARAM_VALUE.r_b6 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.r_b6}] ${MODELPARAM_VALUE.r_b6}
}

proc update_MODELPARAM_VALUE.r_b7 { MODELPARAM_VALUE.r_b7 PARAM_VALUE.r_b7 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.r_b7}] ${MODELPARAM_VALUE.r_b7}
}

proc update_MODELPARAM_VALUE.r_b8 { MODELPARAM_VALUE.r_b8 PARAM_VALUE.r_b8 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.r_b8}] ${MODELPARAM_VALUE.r_b8}
}

proc update_MODELPARAM_VALUE.r_b9 { MODELPARAM_VALUE.r_b9 PARAM_VALUE.r_b9 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.r_b9}] ${MODELPARAM_VALUE.r_b9}
}
