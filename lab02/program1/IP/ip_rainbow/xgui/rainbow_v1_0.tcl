...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "violet" -parent ${Page_0}
...
proc update_PARAM_VALUE.violet { PARAM_VALUE.violet } {
	# Procedure called to update violet when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.violet { PARAM_VALUE.violet } {
	# Procedure called to validate violet
	return true
}
...
proc update_MODELPARAM_VALUE.violet { MODELPARAM_VALUE.violet PARAM_VALUE.violet } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.violet}] ${MODELPARAM_VALUE.violet}
}
