...
#
# Generated by export_simulation on Sun Jan 12 22:50:44 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './simulate_1.sh' script.

./simulate_1.sh -reset_run
...
./simulate_1.sh -noclean_files

For more information on the script, please type './simulate_1.sh -help'.
