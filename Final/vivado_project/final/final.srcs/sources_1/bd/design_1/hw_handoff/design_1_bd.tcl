...
proc create_root_design { parentCell } {
  ...
  # Create instance: mem_ctrl_1, and set properties
  set mem_ctrl_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:mem_ctrl:1.0 mem_ctrl_1 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins mem_ctrl_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins mem_ctrl_1/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins ps7_0_axi_periph/M02_AXI] [get_bd_intf_pins start_signal_0/S00_AXI]
  ...
  connect_bd_net -net mem_ctrl_0_address_out [get_bd_pins mem_ctrl_0/address_out] [get_bd_pins mem_inst_0/address]
  connect_bd_net -net mem_ctrl_0_mem256_out [get_bd_pins mem_ctrl_0/mem256_out] [get_bd_pins mem_inst_0/data_in]
  connect_bd_net -net mem_ctrl_0_write_enable [get_bd_pins mem_ctrl_0/write_enable] [get_bd_pins mem_inst_0/write_enable]
  connect_bd_net -net mem_ctrl_1_address_out [get_bd_pins mem_ctrl_1/address_out] [get_bd_pins mem_data_0/address]
  connect_bd_net -net mem_ctrl_1_mem256_out [get_bd_pins mem_ctrl_1/mem256_out] [get_bd_pins mem_data_0/data_in]
  connect_bd_net -net mem_ctrl_1_write_enable [get_bd_pins mem_ctrl_1/write_enable] [get_bd_pins mem_data_0/write_enable]
  connect_bd_net -net mem_data_0_L_data_out [get_bd_pins mem_data_0/L_data_out] [get_bd_pins mux_2_3/s2]
  connect_bd_net -net mem_data_0_data_out [get_bd_pins mem_ctrl_1/mem256_in] [get_bd_pins mem_data_0/data_out]
  connect_bd_net -net mem_inst_0_data_out [get_bd_pins mem_ctrl_0/mem256_in] [get_bd_pins mem_inst_0/data_out]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins mem_ctrl_0/s00_axi_aclk] [get_bd_pins mem_ctrl_1/s00_axi_aclk] [get_bd_pins mem_data_0/clk] [get_bd_pins mem_inst_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins reg_Control_D_0/clk] [get_bd_pins reg_Control_E_0/clk] [get_bd_pins reg_Control_M_0/clk] [get_bd_pins reg_Control_W_0/clk] [get_bd_pins reg_E_0/clk] [get_bd_pins reg_M_0/clk] [get_bd_pins reg_W_0/clk] [get_bd_pins reg_pc_0/clk] [get_bd_pins regfile_0/clk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins start_signal_0/s00_axi_aclk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins mem_ctrl_0/s00_axi_aresetn] [get_bd_pins mem_ctrl_1/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins reg_Control_D_0/rst] [get_bd_pins reg_Control_E_0/rst] [get_bd_pins reg_Control_M_0/rst] [get_bd_pins reg_Control_W_0/rst] [get_bd_pins reg_E_0/rst] [get_bd_pins reg_M_0/rst] [get_bd_pins reg_W_0/rst] [get_bd_pins reg_pc_0/rst] [get_bd_pins regfile_0/rst] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins start_signal_0/s00_axi_aresetn]
  connect_bd_net -net start_signal_0_start_signal [get_bd_pins reg_pc_0/start_signal] [get_bd_pins start_signal_0/start_signal]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mem_ctrl_0/S00_AXI/S00_AXI_reg] SEG_mem_ctrl_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mem_ctrl_1/S00_AXI/S00_AXI_reg] SEG_mem_ctrl_1_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs start_signal_0/S00_AXI/S00_AXI_reg] SEG_start_signal_0_S00_AXI_reg
