...
HD_PWD='C:/FPGALAB/final_v4/final/final.runs/design_1_reg_Control_D_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_reg_Control_D_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_reg_Control_D_0_0.tcl
