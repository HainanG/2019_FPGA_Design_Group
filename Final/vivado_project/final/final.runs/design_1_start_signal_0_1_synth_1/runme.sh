...
HD_PWD='C:/FPGALAB/final_v4/final/final.runs/design_1_start_signal_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_start_signal_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_start_signal_0_1.tcl
